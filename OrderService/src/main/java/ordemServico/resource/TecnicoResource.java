...
public class TecnicoResource {
	...
	@PutMapping(value = "{id}")	
	public ResponseEntity<TecnicoDTO> atualizar(@PathVariable Long id, @Valid @RequestBody TecnicoDTO tecnicoDTO){
		
		TecnicoDTO tecnicoupdate = tecnicoService.update(id,tecnicoDTO);
		
		return new ResponseEntity<TecnicoDTO>(tecnicoupdate, HttpStatus.CREATED);
	}
